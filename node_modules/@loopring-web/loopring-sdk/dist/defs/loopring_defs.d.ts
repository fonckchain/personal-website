...
import { AmmPoolActivityStatus, AmmTxType, AssetType, BillType, Currency, IntervalType, MarketStatus, OffchainFeeReqType, OffchainNFTFeeReqType, OrderStatus, OrderType, OrderTypeResp, ReqMethod, RuleType, Side, SIG_FLAG, TradeChannel, TradingInterval, TransferType, TxStatus, TxType, UserBillTypes, UserNFTTxTypes, UserTxTypes, WithdrawalTypes } from "./loopring_enums";
...
export declare type XOR<T, U> = T | U extends {
    [key: string]: any;
...
export declare type VipFeeRateInfoMap = {
    [key: string]: VipFeeRateInfo;
};
export declare type TX_HASH_API = {
    hash?: string;
    resultInfo?: RESULT_INFO;
};
export declare type TX_HASH_RESULT<T> = T & {
    raw_data: T;
};
...
export declare enum NetworkWallet {
    ETHEREUM = "ETHEREUM",
    ARBITRUM = "ARBITRUM",
    GOERLI = "GOERLI",
    TAIKO = "TAIKO"
...
export declare enum AMMtxTypes {
    JOIN = 0,
    EXIT = 1
}
...
export declare enum OrderMakerType {
    taker = "taker",
    maker = "maker"
}
...
export declare type GetOffchainFeeAmtRequest = ({
    accountId: number;
    amount?: string;
} & {
    requestType: Omit<OffchainFeeReqType, OffchainFeeReqType.OFFCHAIN_WITHDRAWAL | OffchainFeeReqType.AMM_JOIN | OffchainFeeReqType.AMM_EXIT | OffchainFeeReqType.ORDER | OffchainFeeReqType.FAST_OFFCHAIN_WITHDRAWAL>;
}) | {
    requestType: OffchainFeeReqType.OFFCHAIN_WITHDRAWAL | OffchainFeeReqType.AMM_JOIN | OffchainFeeReqType.AMM_EXIT | OffchainFeeReqType.ORDER;
    tokenSymbol: string;
} | {
 ...
 */
export declare type GetNFTOffchainFeeAmtRequest = {
    accountId: number;
    amount?: string;
} & XOR<{
...
export declare type UserPwdResetTx = UserRegTx;
...
export declare enum TradesFillTypes {
    dex = "dex",
    amm = "amm"
}
...
export declare type UserTrade = MarketTradeInfo;
...
export interface OriginNFTTransferRequestV3 {
     ...
     * @memberof OriginNFTTransferRequestV3
     */
    maxFee: Pick<TokenVolumeV3, "tokenId"> & {
        amount: string;
    };
    /**
     * offchain Id
 ...
 */
export declare type NFTOrderRequestV3 = {
    /**
     * exchange address
     * @type {string}
...
export declare enum DEPLOYMENT_STATUS {
    NOT_DEPLOYED = "NOT_DEPLOYED",
    DEPLOY_FAILED = "DEPLOY_FAILED",
    DEPLOYING = "DEPLOYING",
    DEPLOYED = "DEPLOYED"
}
export declare enum NFT_IMAGE_SIZES {
    small = "240-240",
    large = "332-332",
    original = "original"
}
export declare type IPFS_METADATA = {
    uri: string;
    base: {
        name: string;
        decimals: number;
...
export declare type NftData = string;
...
export declare type GetUserNFTTransferHistoryRequest = {
    accountId: number;
    nftData?: string;
    start?: number;
    end?: number;
...
export declare type GetUserNFTMintHistoryRequest = {
    accountId: number;
    nftData?: string;
    start?: number;
    startId?: number;
...
export declare type GetUserNFTDepositHistoryRequest = {
    accountId: number;
    nftData?: string;
    start?: number;
    end?: number;
...
export declare type GetUserNFTWithdrawalHistoryRequest = {
    accountId: number;
    nftData?: string;
    start?: number;
    end?: number;
...
export declare type UserNFTMintHistoryTx = {
    id: string;
    requestId: number;
    hash: string;
    txHash: string;
...
export declare type Protector = {
    ens: string;
    address: string;
    lockStatus: HEBAO_LOCK_STATUS;
};
export declare type HebaoOperationLog = {
    createdAt: number;
    ens: string;
    from: string;
 ...
 */
export declare type GuardiaContractAddress = string;
...
export declare enum DefiAction {
    Deposit = "deposit",
    Withdraw = "withdraw"
}
...
export declare type CollectionExtendsKey = {
    thumbnail?: string;
    cid?: string;
    id?: string;
    contractAddress: string;
...
export declare type CollectionBasicMeta = {
    name: string;
    tileUri: string;
    nftFactory?: string;
    description?: string;
...
export declare type CollectionLegacyMeta = Omit<CollectionBasicMeta, "owner"> & {
    accountId: number;
    tokenAddress: string;
};
export declare enum NFT_PREFERENCE_TYPE {
    fav = "fav",
    hide = "hide"
}
export declare type UpdateNFTLegacyCollectionRequest = {
    accountId: number;
    nftHashes: string[];
    collectionId?: number;
};
export declare type UpdateNFTGroupRequest = {
    accountId: number;
    nftHashes: string[];
    collectionId?: number;
 ...
 *
 */
export declare type CollectionMeta = CollectionExtendsKey & CollectionBasicMeta;
...
export declare enum DUAL_TYPE {
    DUAL_BASE = "DUAL_BASE",
    DUAL_CURRENCY = "DUAL_CURRENCY"
}
export declare type GetDualInfosRequest = {
    baseSymbol: string;
    quoteSymbol: string;
    currency: string;
    dualType: DUAL_TYPE;
...
export declare type GetDualPricesRequest = {
    baseSymbol: string;
    productIds: string;
};
export declare type GetDualRuleRequest = {
    baseSymbol: string;
    currency?: string;
};
export declare type DualBid = {
    baseProfit: string;
    baseQty: string;
};
export declare type DualPrice = {
    productId: string;
    cacheQty: string;
    priceTime: number;
    dualBid: DualBid[];
};
export declare type DualIndex = {
    index: string;
    base: string;
    quote: string;
    indexTime: number;
};
export declare type DualProductAndPrice = {
    productId: string;
    base: string;
    quote: string;
    currency: string;
...
export declare type DualRulesCoinsInfo = {
    base: string;
    quote: string;
    currency: string;
...
export declare type DualBalance = {
    coin: string;
    free: string;
    frozen: string;
};
export declare enum LABEL_INVESTMENT_STATUS {
    PROCESSED = "processed",
    FAILED = "failed",
...
export declare type CalDualResult = {
    sellVol: string;
    quota: string;
    lessEarnVol: string;
...
export declare enum LuckyTokenItemStatusIndex {
    SUBMITTING = 0,
    NOT_EFFECTIVE = 1,
    PENDING = 2,
    COMPLETED = 3,
...
export declare enum LuckyTokenWithdrawStatus {
    RECEIVED = 0,
    PROCESSING = 1,
    PROCESSED = 2,
    WITHDRAW_FAILED = 3,
...
export declare enum LuckyTokenItemStatus {
...
export declare enum LuckyTokenAmountType {
    RANDOM = 0,
    AVERAGE = 1
}
export declare enum LuckyTokenViewType {
    PUBLIC = 0,
    PRIVATE = 1
}
export declare enum LuckyTokenClaimType {
    RELAY = 0,
    COMMON = 1,
    BLIND_BOX = 2
}
export declare enum ClaimRecordStatus {
    WAITING_CLAIM = "WAITING_CLAIM",
    CLAIMED = "CLAIMED",
    EXPIRED = "EXPIRED"
}
export declare enum BlindBoxStatus {
    NOT_OPENED = "NOT_OPENED",
    OPENED = "OPENED",
    EXPIRED = "EXPIRED"
}
export declare type LuckyTokenChampion = {
    accountId: number;
    address: string;
    ens: string;
    amount: number;
};
export declare type LuckyTokenAmount = {
    totalCount: number;
    remainCount: number;
    totalAmount: string;
    remainAmount: string;
...
export declare type LuckyTokenType = {
    partition: LuckyTokenAmountType;
    scope: LuckyTokenViewType;
    mode: LuckyTokenClaimType;
};
export declare type LuckyTokenInfo = {
    memo: string;
    signer: string;
    signerUrl: string;
    logoUrl: string;
};
export declare type LuckyTokenSender = {
    accountId: number;
    address: string;
    ens: string;
};
export declare type LuckyTokenItemForReceive = {
    hash: string;
...
export declare type BlindBoxClaimInfo = {
    id: number;
    hash: string;
    claimer: {
        accountId: number;
...
export declare type LuckyTokenBlindBoxItemReceive = {
    luckyToken: LuckyTokenItemForReceive;
    claim: BlindBoxClaimInfo;
};
export declare type LuckTokenClaim = {
    hash: string;
    claimer: {
        accountId: number;
        address: string;
...
export declare type LuckyTokenSignerFlag = 0 | 1;
export declare type LuckTokenHistory = {
    champion: LuckyTokenChampion;
    claimAmount: number;
    claim: {
        id: number;
...
export declare type LuckTokenClaimDetail = {
    champion: LuckyTokenChampion;
    claimAmount: number;
    claims: Array<{
        id: number;
...
export declare type LuckTokenWithdraw = {
    id: number;
    hash: string;
    claimer: {
        accountId: number;
 ...
 *
 */
export declare type LuckyTokenItemForSendV3 = {
    type: LuckyTokenType;
    /**
     * numbers
...
export declare type STACKING_PRODUCT = {
    tokenId: number;
    symbol: string;
    address: string;
    decimals: number;
...
export declare type StakeInfoOrigin = {
    accountId: number;
    tokenId: number;
    stakeAt: number;
    createdAt: number;
...
export declare type STACKING_SUMMARY = {
    totalStaked: string;
...
export declare type STACKING_TRANSACTIONS = {
    accountId: number;
    tokenId: number;
    amount: string;
    productId: string;
...
export declare type CEX_MARKET = {
    market: string;
    baseTokenId: number;
    quoteTokenId: number;
    precisionForPrice: number;
