...
export declare type ContractNFTParam = {
    web3: any;
    tokenAddress: string;
    nftId: string;
    nftType?: NFTType;
};
export declare type ContractNFTMetaParam = ContractNFTParam & {
    _id?: string;
};
export declare type UserNFTBalanceParam = ContractNFTParam & {
    account: string;
};
export declare type CallRefreshNFT = {
    network: "ETHEREUM";
    tokenAddress: string;
    nftId: string;
