export declare enum LoopringErrorCode {
    ...
    Invalid_AccountId = 102003,
    Invalid_OrderId = 102004,
    Market_Not_Supported = 102005,
    Illegal_Rate = 102006,
...
export declare enum ConnectorError {
...
export declare type ERROR_INFO = {
    resultInfo: RESULT_INFO;
};
export declare const checkErrorInfo: (errorInfo: RESULT_INFO, isFirstTime?: boolean | undefined) => string | undefined;
