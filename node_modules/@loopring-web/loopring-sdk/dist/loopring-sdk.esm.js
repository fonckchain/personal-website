import { toBuffer as toBuffer$1, toChecksumAddress, sha256, sha3, hashPersonalMessage, fromRpcSig, keccak256, pubToAddress, ecrecover, keccak, toRpcSig } from 'ethereumjs-util';
import BN from 'bn.js';
import BigNumber from 'bignumber.js';
import axios from 'axios';
import sha256$1 from 'crypto-js/sha256';
import { soliditySHA3, methodID, rawEncode, rawDecode } from 'ethereumjs-abi';
...
var NFTFactory = (_NFTFactory = {}, _NFTFactory[ChainId.MAINNET] = "0xc852aC7aAe4b0f0a0Deb9e8A391ebA2047d80026", _NFTFactory[ChainId.GOERLI] = "0x0ad87482a1bfd0B3036Bb4b13708C88ACAe1b8bA", _NFTFactory);
var NFTFactory_Collection = (_NFTFactory_Collectio = {}, _NFTFactory_Collectio[ChainId.MAINNET] = "0x97BE94250AEF1Df307749aFAeD27f9bc8aB911db", _NFTFactory_Collectio[ChainId.GOERLI] = "0x0ad87482a1bfd0B3036Bb4b13708C88ACAe1b8bA", _NFTFactory_Collectio);
...
var getOrderBookArg = function getOrderBookArg(_ref) {
  var _ref$topic = _ref.topic,
      topic = _ref$topic === void 0 ? WsTopicType.orderbook : _ref$topic,
      market = _ref.market,
      level = _ref.level,
      count = _ref.count,
...
var getMixOrderArg = function getMixOrderArg(_ref2) {
  var _ref2$topic = _ref2.topic,
      topic = _ref2$topic === void 0 ? WsTopicType.mixorder : _ref2$topic,
...
var getCefiOrderBook = function getCefiOrderBook(_ref3) {
  var _ref3$topic = _ref3.topic,
      topic = _ref3$topic === void 0 ? WsTopicType.cefiOrderBook : _ref3$topic,
...
})(LOOPRING_URLs || (LOOPRING_URLs = {}));

var HEBAO_LOCK_STATUS;
...
})(HEBAO_LOCK_STATUS || (HEBAO_LOCK_STATUS = {}));
...
})(HEBAO_META_TYPE || (HEBAO_META_TYPE = {}));
...
})(OffchainFeeReqType || (OffchainFeeReqType = {}));

var OffchainNFTFeeReqType;
...
})(OffchainNFTFeeReqType || (OffchainNFTFeeReqType = {}));
...
})(DefiMarketStatus || (DefiMarketStatus = {}));
...
})(TradesFillTypes || (TradesFillTypes = {}));
...
})(NFT_IMAGE_SIZES || (NFT_IMAGE_SIZES = {}));
...
})(LABEL_INVESTMENT_STATUS || (LABEL_INVESTMENT_STATUS = {}));
...
})(LuckyTokenItemStatusIndex || (LuckyTokenItemStatusIndex = {}));

var LuckyTokenWithdrawStatus;
...
})(LuckyTokenWithdrawStatus || (LuckyTokenWithdrawStatus = {}));

var LuckyTokenItemStatus;
...
})(LuckyTokenItemStatus || (LuckyTokenItemStatus = {}));

var LuckyTokenAmountType;
...
})(LuckyTokenAmountType || (LuckyTokenAmountType = {}));

var LuckyTokenViewType;
...
})(LuckyTokenViewType || (LuckyTokenViewType = {}));

var LuckyTokenClaimType;
...
})(LuckyTokenClaimType || (LuckyTokenClaimType = {}));

var ClaimRecordStatus;
...
})(ClaimRecordStatus || (ClaimRecordStatus = {}));
...
})(StakeTransactionType || (StakeTransactionType = {}));
...
})(LoopringErrorCode || (LoopringErrorCode = {}));
...
function formatAddress(mixed) {
  if (mixed instanceof Buffer || mixed instanceof Uint8Array) {
    return toChecksumAddress("0x" + mixed.toString("hex"));
  }

  if (typeof mixed === "string") {
    return toChecksumAddress(mixed.startsWith("0x") ? mixed : "0x" + mixed);
  }
...
function makeMarkets(raw_data, url) {
  if (url === void 0) {
    url = LOOPRING_URLs.GET_MARKETS;
  }

  var markets = {};
  var pairs = {};
  var isMix = url === LOOPRING_URLs.GET_MIX_MARKETS;
  ...
  if ((raw_data == null ? void 0 : raw_data.markets) instanceof Array) {
    raw_data.markets.forEach(function (item) {
      ...
      if (isMix) {
        ...
        marketInfo.isSwapEnabled = marketInfo.status === MarketStatus.ALL || marketInfo.status === MarketStatus.AMM;
...
typeof window !== "undefined" && (_window = window) != null && _window.___OhTrustDebugger___) {
  _myLog = console.log;
} else {
  _myLog = function _myLog(message) {
    return "";
  };
}

if (process.env.NODE_ENV !== "production" || // @ts-ignore
typeof window !== "undefined" && (_window2 = window) != null && _window2.___OhTrustDebugger___) ;
...
field.SNARK_SCALAR_FIELD = /*#__PURE__*/BigNumber$1.from("21888242871839275222246405745257275088548364400416034343698204186575808495617"); // Fr is the scalar field of Jubjub

field.FR_ORDER = /*#__PURE__*/BigNumber$1.from("21888242871839275222246405745257275088614511777268538073601725287587578984328"); // A class for field elements in FQ. Wrap a number in this class,
...
var FQ = /*#__PURE__*/function () {
  ...
  FQ.one = function one(modulus) {
    ...
    return new FQ(BigNumber$1.from("1"), modulus);
  };
  ...
  FQ.zero = function zero(modulus) {
    ...
    return new FQ(BigNumber$1.from("0"), modulus);
  };

  return FQ;
}();
function modulo(n, p, m) {
  var n_ = new BigInteger(n.toString());
  var p_ = new BigInteger(p.toString());
  var m_ = new BigInteger(m.toString()); // console.log("modulo", n_.toString(), p_.toString(), m_.toString());

  var result = n_.modPow(p_, m_); // console.log(n_.toString(), p_.toString(), m_.toString(), result.toString())

  return BigNumber$1.from(result.toString());
}
...
jubjub.JUBJUB_E = /*#__PURE__*/BigNumber$1.from("21888242871839275222246405745257275088614511777268538073601725287587578984328");
jubjub.JUBJUB_C = /*#__PURE__*/BigNumber$1.from("8"); // Cofactor

jubjub.JUBJUB_L = /*#__PURE__*/jubjub.JUBJUB_E.div(jubjub.JUBJUB_C); // L*B = 0, and (2^C)*L == #E

jubjub.JUBJUB_A = /*#__PURE__*/BigNumber$1.from("168700"); // Coefficient A

jubjub.JUBJUB_D = /*#__PURE__*/BigNumber$1.from("168696"); // Coefficient D
...
var Point = /*#__PURE__*/function () {
  ...
  Point.generate = function generate() {
    var xBigInt = BigNumber$1.from("16540640123574156134436876038791482806971768689494387082833631921987005038935");
    var yBigInt = BigNumber$1.from("20819045374670962167435360035096875258406992893633759881276124905556507972311");
  ...
  _proto.mul = function mul(scaler) {
    ...
    while (!scaler.eq(BigNumber$1.from("0"))) {
      var bitwiseAnd = scaler.and(BigNumber$1.from("1"));

      if (!bitwiseAnd.eq(BigNumber$1.from("0"))) {
        a = a.add(p);
      }
      ...
      p = copyP1.add(copyP2);
      scaler = scaler.div(BigNumber$1.from("2")); // console.log(i + " scaler", scaler.toString())
    }
  ...
  _proto.add = function add(other) {
    if (this.x.n.eq(BigNumber$1.from("0")) && this.y.n.eq(BigNumber$1.from("0"))) {
      return other;
    }
  ...
  Point.infinity = function infinity() {
    return new Point(new FQ(BigNumber$1.from("0")), new FQ(BigNumber$1.from("1")));
  };
...
var permunation = /*#__PURE__*/function () {
  ...
  permunation.H = function H(arg) {
    ...
    for (var i = 0; i < items.length; i++) {
      var itemBigInt = BigNumber$1.from(items[i]);
      var tmp = itemBigInt.mul(BigNumber$1.from("256").pow(BigNumber$1.from(i)));
      sum = sum.add(tmp);
    } // console.log(`sum ${sum}`)
...
var SignatureScheme = /*#__PURE__*/function () {
  ...
  */
  ...
  SignatureScheme.hash_secret_python = function hash_secret_python(k, arg) {
    ...
    var digest1 = sha512.array(new Uint8Array(sum).buffer); // let digest1 = createHash('sha512').update .digest("SHA-512", new Uint8Array(sum).buffer)
    ...
    var sha512MessageHexStrBigInt = BigNumber$1.from("0x" + sha512MessageHexStr); // console.log(`sha512MessageHexStrBigInt ${sha512MessageHexStrBigInt}`)
  ...
  SignatureScheme.sign = function sign(msg, key, B) {
    ...
    var copy_r = BigNumber$1.from(r.toString());
  ...
  SignatureScheme.hash_public = function hash_public(R, A, M) {
    ...
    var params = new PoseidonParams(field.SNARK_SCALAR_FIELD, 6, 6, 52, "poseidon", BigNumber$1.from(5), null, null, 128);
...
var babyJub = /*#__PURE__*/function () {
  ...
  babyJub.packPoint = function packPoint(P0, P1) {
    ...
    if (babyJub.lt(P0, BigNumber$1.from("0"))) {
  ...
  babyJub.lt = function lt(a, b) {
    var half = field.SNARK_SCALAR_FIELD.div(BigNumber$1.from("2"));
...
var EDDSAUtil = /*#__PURE__*/function () {
  ...
  EDDSAUtil.sign = function sign(PrivateKey, hash) {
    var strKey = BigNumber$1.from(PrivateKey);
    var msg = BigNumber$1.from(hash); // console.log("strKey", strKey.toString())
  ...
  EDDSAUtil.generateKeyPair = function generateKeyPair(seed) {
    var bigInt = BigNumber$1.from(0);

    for (var i = 0; i < seed.length; i++) {
      var item = seed[i];
      var itemBigInt = BigNumber$1.from(item);
      var tmp = BigNumber$1.from("256").pow(BigNumber$1.from(i));
    ...
    var copySecretKey = BigNumber$1.from(secretKey.toString()); // console.log("copySecretKey", copySecretKey.toString())
  ...
  EDDSAUtil.pack = function pack(publicKeyX, publicKeyY) {
    var P0 = BigNumber$1.from(publicKeyX);
    var P1 = BigNumber$1.from(publicKeyY);
...
})(GetEcDSASigType || (GetEcDSASigType = {}));
...
function generatePrivateKey(result) {
  if (!result.error) {
    ...
    var seedBuff = sha256(toBuffer(result.sig)); // myLog(`seedBuff.toString('hex') ${seedBuff.toString('hex')}`)

    var seed = BigNumber$1.from("0x" + seedBuff.toString("hex")); // myLog(`seed ${seed.toString()}`)
...
function getEdDSASig(method, basePath, api_url, requestInfo, PrivateKey) {
  ...
  var _hash = new BigNumber(sha256$1(message).toString(), 16);
...
var getEdDSASigWithPoseidon = function getEdDSASigWithPoseidon(inputs, PrivateKey) {
  var p = field.SNARK_SCALAR_FIELD;
  var poseidonParams = new PoseidonParams(p, inputs.length + 1, 6, 53, "poseidon", BigNumber$1.from(5), null, null, 128);
  var bigIntInputs;
  bigIntInputs = [];

  for (var i = 0; i < inputs.length; i++) {
    var input = inputs[i];
    bigIntInputs.push(BigNumber$1.from(input));
  }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.t0 = type;
            _context4.next = _context4.t0 === GetEcDSASigType.HasDataStruct ? 6 : _context4.t0 === GetEcDSASigType.WithoutDataStruct ? 12 : _context4.t0 === GetEcDSASigType.Contract ? 22 : 31;
            break;
          ...
          case 12:
            hash = TypedDataUtils.sign(typedData);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return getEcDSASig(web3, typedData, bodyParams.owner, GetEcDSASigType.HasDataStruct, chainId, accountId, "", ConnectorNames.Unknown, counterFactualInfo);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return getEcDSASig(web3, typedData, bodyParams.owner, GetEcDSASigType.WithoutDataStruct, chainId, accountId, "", walletType, counterFactualInfo);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            typedData = getUpdateAccountEcdsaTypedData(bodyParams, chainId);
            _context7.next = 3;
            return getEcDSASig(web3, typedData, bodyParams.owner, GetEcDSASigType.Contract, chainId, accountId, "", ConnectorNames.Unknown, counterFactualInfo);
...
function get_EddsaSig_OffChainWithdraw(request, eddsaKey) {
  var onchainDataHash = soliditySHA3(["uint256", "address", "bytes"], [request.minGas, new BN(clearHexPrefix(request.to), 16), toBuffer$1(request.extraData)]).slice(0, 20);
  var orderHashStr = addHexPrefix(onchainDataHash.toString("hex"));
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.accountId, request.token.tokenId, request.token.volume, request.maxFee.tokenId, request.maxFee.volume, orderHashStr, request.validUntil, request.storageId];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
function getOrderHash(request) {
  var p = field.SNARK_SCALAR_FIELD;
  var poseidonParams = new PoseidonParams(p, 12, 6, 53, "poseidon", BigNumber$1.from(5), null, null, 128);
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.storageId, request.accountId, request.sellToken.tokenId, request.buyToken.tokenId, request.sellToken.volume, request.buyToken.volume, request.validUntil, request.maxFeeBips, request.fillAmountBOrS ? 1 : 0, new BN(toBuffer$1(request.taker)).toString()];
  var bigIntInputs;
  bigIntInputs = [];
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.next = 3;
            return getEcDSASig(web3, typedData, owner, GetEcDSASigType.HasDataStruct, chainId, accountId, "", ConnectorNames.Unknown, counterFactualInfo);
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            typedData = getWithdrawTypedData(bodyParams, chainId);
            _context9.next = 3;
            return getEcDSASig(web3, typedData, owner, GetEcDSASigType.WithoutDataStruct, chainId, accountId, "", walletType, counterFactualInfo);
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            typedData = getWithdrawTypedData(bodyParams, chainId);
            _context10.next = 3;
            return getEcDSASig(web3, typedData, owner, GetEcDSASigType.Contract, chainId, accountId, "", ConnectorNames.Unknown, counterFactualInfo);
...
function get_EddsaSig_NFT_Withdraw(request, eddsaKey) {
  var onchainDataHash = soliditySHA3(["uint256", "address", "bytes"], [request.minGas, new BN(clearHexPrefix(request.to), 16), toBuffer$1(request.extraData)]).slice(0, 20);
  var orderHashStr = addHexPrefix(onchainDataHash.toString("hex"));
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.accountId, request.token.tokenId, request.token.amount, request.maxFee.tokenId, request.maxFee.amount, orderHashStr, request.validUntil, request.storageId];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
function getNftData(request) {
  var p = field.SNARK_SCALAR_FIELD;
  var poseidonParams = new PoseidonParams(p, 7, 6, 52, "poseidon", BigNumber$1.from(5), null, null, 128);
...
function get_EddsaSig_NFT_Mint(request, eddsaKey) {
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.minterId, request.toAccountId, getNftData(request), request.amount, request.maxFee.tokenId, request.maxFee.amount, request.validUntil, request.storageId];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
...
function get_EddsaSig_NFT_Order(request, eddsaKey) {
  ...
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.storageId, request.accountId, (_request$sellToken = request.sellToken) != null && _request$sellToken.tokenId ? request.sellToken.tokenId : "", (_request$buyToken = request.buyToken) != null && _request$buyToken.nftData ? request.buyToken.nftData : request.buyToken.tokenId, (_request$sellToken2 = request.sellToken) != null && _request$sellToken2.amount ? request.sellToken.amount : 0, (_request$buyToken2 = request.buyToken) != null && _request$buyToken2.amount ? request.buyToken.amount : 0, request.validUntil, request.maxFeeBips, fillAmountBOrS, new BN(toBuffer$1(request.taker)).toString()];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
function get_EddsaSig_Dual_Order(request, eddsaKey) {
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.storageId, request.accountId, request.sellToken.tokenId, request.buyToken.tokenId, request.sellToken.volume, request.buyToken.volume, request.validUntil, request.maxFeeBips, request.fillAmountBOrS ? 1 : 0, 0];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
...
function get_EddsaSig_Transfer(request, eddsaKey) {
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.payerId, request.payeeId, request.token.tokenId, request.token.volume, request.maxFee.tokenId, request.maxFee.volume, new BN(toBuffer$1(request.payeeAddr)).toString(), 0, 0, request.validUntil, request.storageId];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
...
function get_EddsaSig_NFT_Transfer(request, eddsaKey) {
  var inputs = [new BN(toBuffer$1(request.exchange)).toString(), request.fromAccountId, request.toAccountId, request.token.tokenId, request.token.amount, request.maxFee.tokenId, request.maxFee.amount, new BN(toBuffer$1(request.toAddress)).toString(), 0, 0, request.validUntil, request.storageId];
  return getEdDSASigWithPoseidon(inputs, eddsaKey);
}
...
function eddsaSign(typedData, eddsaKey) {
  var hash = toHex(TypedDataUtils.sign(typedData));
...
function eddsaSignWithDomain(domainHax, primaryType, message, types, eddsaKey) {
  ...
  parts.push(TypedDataUtils.hashStruct(primaryType, message, types));
  var hash = toHex(sha3(Buffer.concat(parts)));
  var sigHash = toHex(new BigNumber(hash, 16).idiv(8));
  var signature = EDDSAUtil.sign(eddsaKey, sigHash);
  return {
    eddsaSig: formatEddsaKey(toHex(toBig(signature.Rx))) + clearHexPrefix(formatEddsaKey(toHex(toBig(signature.Ry)))) + clearHexPrefix(formatEddsaKey(toHex(toBig(signature.s))))
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!(params.sigFlag !== SIG_FLAG.NO_SIG && !(params != null && (_params$sigObj2 = params.sigObj) != null && _params$sigObj2.dataToSig))) {
                _context.next = 10;
                break;
              }
            ...
            case 10:
              ...
              _context.next = _context.t0 === SIG_FLAG.NO_SIG ? 13 : _context.t0 === SIG_FLAG.EDDSA_SIG_POSEIDON ? 14 : _context.t0 === SIG_FLAG.EDDSA_SIG ? 16 : 18;
              break;
...
var Contract = /*#__PURE__*/function () {
  function Contract(abi) {
    ...
    this.abiFunctions = funAbi.reduce(function (acc, item) {
      ...
      var methodHash = methodID(item.name, inputTypes);
...
var BaseAPI = /*#__PURE__*/function () {
  function BaseAPI(param, timeout, baseUrlMap) {
    ...
    if (baseUrlMap === void 0) {
      ...
      baseUrlMap = (_baseUrlMap = {}, _baseUrlMap[ChainId.MAINNET] = "https://api3.loopring.io", _baseUrlMap[ChainId.GOERLI] = "https://uat2.loopring.io", _baseUrlMap);
    }
  ...
  _proto.genErr = function genErr(err) {
    if (err.hasOwnProperty("request")) {
      ...
      var key = Reflect.ownKeys(ConnectorError).find(function (key) {
        return (err == null ? void 0 : err.message.search(ConnectorError[key])) !== -1;
      });

      if (key) {
        return _extends({}, err, {
          message: key,
          code: LoopringErrorCode[key]
        });
      }
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", new Promise(function (resolve) {
              var hash = hashPersonalMessage(toBuffer(msg));
          ...
          case 0:
            ...
            return _context5.abrupt("return", new Promise(function (resolve) {
              web3.eth.call({
                ...
                if (!err) {
                  var signature = fromRpcSig(sig);
                  var hash = hashPersonalMessage(keccak256(toBuffer(msg)));
                  var address = addHexPrefix(contracts.Contracts.ContractWallet.decodeOutputs("getKeyData", res)[0]);
                  var recAddress = toHex(pubToAddress(ecrecover(hash, signature.v, signature.r, signature.s)));
                  resolve({
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            totalHash = keccak(Buffer.concat(parts));
            ...
            v = old_v;
            if (v <= 1) v += 27;
            pub = ecrecover(totalHash, v, r, s);
            recoveredAddress = "0x" + pubToAddress(pub).toString("hex");
...
var getBaseUrlByChainId = function getBaseUrlByChainId(id, baseUrlMap) {
  if (baseUrlMap === void 0) {
    ...
    baseUrlMap = (_baseUrlMap2 = {}, _baseUrlMap2[ChainId.MAINNET] = "https://api3.loopring.io", _baseUrlMap2[ChainId.GOERLI] = "https://uat2.loopring.io", _baseUrlMap2);
  }
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 6:
              return _context3.abrupt("return", {
                orderbookTradingFeesStablecoin: raw_data[VipCatergory.ORDERBOOK_TRADING_FEES_STABLECOIN],
                orderbookTradingFees: raw_data[VipCatergory.ORDERBOOK_TRADING_FEES],
                ammTradingFees: raw_data[VipCatergory.AMM_TRADING_FEES],
                otherFees: raw_data[VipCatergory.OTHER_FEES],
                raw_data: raw_data
              });
      ...
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return this.getMarkets(LOOPRING_URLs.GET_MIX_MARKETS);
      ...
      return runtime_1.wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              _context14.next = 2;
              return this.getDepth(request, LOOPRING_URLs.GET_MIX_DEPTH);
      ...
      return runtime_1.wrap(function _callee16$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
            case 0:
              _context16.next = 2;
              return this.getTicker(request, LOOPRING_URLs.GET_MIX_TICKER);
      ...
      return runtime_1.wrap(function _callee20$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
            case 0:
              _context20.next = 2;
              return this.getCandlestick(request, LOOPRING_URLs.GET_MIX_CANDLESTICK);
        ...
        while (1) {
          switch (_context21.prev = _context21.next) {
            ...
            case 7:
              ...
              _context21.next = _context21.t0 === TradingInterval.min1 ? 11 : _context21.t0 === TradingInterval.min5 ? 12 : _context21.t0 === TradingInterval.min15 ? 14 : _context21.t0 === TradingInterval.min30 ? 16 : _context21.t0 === TradingInterval.hr1 ? 18 : _context21.t0 === TradingInterval.hr2 ? 20 : _context21.t0 === TradingInterval.hr4 ? 22 : _context21.t0 === TradingInterval.hr12 ? 24 : _context21.t0 === TradingInterval.d1 ? 26 : _context21.t0 === TradingInterval.w1 ? 28 : 30;
              break;
            ...
            case 6:
              ...
              if (raw_data instanceof Array) {
                raw_data.forEach(function (item) {
                  ...
                  var status = currentTs < item.rangeFrom ? AmmPoolActivityStatus.NotStarted : currentTs >= item.rangeFrom && currentTs <= item.rangeTo ? AmmPoolActivityStatus.InProgress : AmmPoolActivityStatus.EndOfGame;
                  item.status = status;
  ...
  _signEthereumTx = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(web3, account, rawTx, chainId) {
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ethTx = Transaction.fromSerializedTx(rawTx);
  ...
  _approve = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(web3, from, to, depositAddress, _value, chainId, nonce, gasPrice, gasLimit, sendByMetaMask) {
    ...
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            data = genERC20Data(ERC20Method.Approve, {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            amount = toHex(valueC);
            data = genExchangeData(ERC20Method.Deposit, {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            valueC = toBig(fee);
            data = genExchangeData(ERC20Method.ForceWithdraw, {
              owner: from,
              tokenAddress: token.address,
              accountID: accountID
            });
        ...
        while (1) {
          switch (_context43.prev = _context43.next) {
            case 0:
              ...
              if (!(walletType === ConnectorNames.MetaMask || walletType === ConnectorNames.Gamestop || walletType === ConnectorNames.OtherExtension)) {
                _context43.next = 23;
                break;
              }
...
var WalletAPI = /*#__PURE__*/function (_BaseAPI) {
  ...
  _proto.rejectApproveHash = function rejectApproveHash(request) {
    var uri = encodeURIComponent("" + (this.baseUrl + LOOPRING_URLs.REJECT_APPROVE_SIGNATURE));
    var params = encodeURIComponent(JSON.stringify({
      approveRecordId: request.approveRecordId,
      signer: request.signer
    }));
    var message = ReqMethod.POST + "&" + uri + "&" + params;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return personalSign(web3, address, "", signHash, ConnectorNames.Unknown, chainId);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 8;
              return getEcDSASig(web3, typedData, owner, GetEcDSASigType.Contract, chainId, undefined, "", ConnectorNames.Unknown // counterFactualInfo
              );
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
                  ...
                  return runtime_1.wrap(function _callee5$(_context5) {
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        ...
                        case 2:
                          result = _context5.sent;
                          ecdsaSignature = (result == null ? void 0 : result.sig) + SigSuffix.Suffix03;
              ...
              if (!(walletType === ConnectorNames.MetaMask || walletType === ConnectorNames.Gamestop || walletType === ConnectorNames.Coinbase || walletType === ConnectorNames.OtherExtension)) {
                _context6.next = 24;
                break;
              }
            ...
            case 26:
              ...
              guardiansHash = keccak(guardiansBs); // const guardiansBs =
...
var _CREATION_CODE;
var CREATION_CODE = (_CREATION_CODE = {}, _CREATION_CODE[ChainId.GOERLI] = "3d602d80600a3d3981f3363d3d373d3d3d363d735854e62554ce1c146a375c370bc0d323368b372d5af43d82803e903d91602b57fd5bf3", _CREATION_CODE[ChainId.MAINNET] = "3d602d80600a3d3981f3363d3d373d3d3d363d73b25f6d711aebf954fb0265a3b29f7b9beba7e55d5af43d82803e903d91602b57fd5bf3", _CREATION_CODE);
var NFTType;
...
})(NFT_TYPE_STRING || (NFT_TYPE_STRING = {}));
...
var NFTAPI = /*#__PURE__*/function (_BaseAPI) {
  ...
  _proto._genContract = function _genContract(web3, contractAddress, type) {
    ...
    return new web3.eth.Contract(type === NFTType.ERC1155 ? contracts.Contracts.erc1155Abi : contracts.Contracts.erc721Abi, contractAddress);
  }
  /**
   * getNFTBalance
   * @param web3
    ...
    var _getNFTBalance = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(_ref) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              web3 = _ref.web3, tokenAddress = _ref.tokenAddress, account = _ref.account, nftId = _ref.nftId, _ref$nftType = _ref.nftType, nftType = _ref$nftType === void 0 ? NFTType.ERC1155 : _ref$nftType;
              _context2.prev = 1;
              ...
              _context2.next = 5;
              return this.callContractMethod(web3, NFTMethod.ownerOf, [nftId], tokenAddress, nftType);
            ...
            case 13:
              _context2.next = 15;
              return this.callContractMethod(web3, NFTMethod.balanceOf, [account, web3.utils.hexToNumberString(nftId)], tokenAddress, nftType);
    ...
    var _getContractNFTMeta = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(_ref3, _IPFS_META_URL) {
      ...
      return runtime_1.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              web3 = _ref3.web3, tokenAddress = _ref3.tokenAddress, nftId = _ref3.nftId, _ref3$nftType = _ref3.nftType, nftType = _ref3$nftType === void 0 ? NFTType.ERC1155 : _ref3$nftType;

              _context5.prev = 2;
              myLog(tokenAddress, "nftid", nftId, web3.utils.hexToNumberString(nftId));
              _context5.next = 6;
              return this.callContractMethod(web3, nftType === NFTType.ERC1155 ? NFTMethod.uri : NFTMethod.tokenURI, [web3.utils.hexToNumberString(nftId)], tokenAddress, nftType);
    ...
    var _approveNFT = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(_ref4) {
      ...
      return runtime_1.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              web3 = _ref4.web3, from = _ref4.from, depositAddress = _ref4.depositAddress, tokenAddress = _ref4.tokenAddress, _ref4$nftType = _ref4.nftType, nftType = _ref4$nftType === void 0 ? NFTType.ERC1155 : _ref4$nftType, gasPrice = _ref4.gasPrice, gasLimit = _ref4.gasLimit, chainId = _ref4.chainId, nonce = _ref4.nonce, _ref4$approved = _ref4.approved, approved = _ref4$approved === void 0 ? true : _ref4$approved, _ref4$sendByMetaMask = _ref4.sendByMetaMask, sendByMetaMask = _ref4$sendByMetaMask === void 0 ? true : _ref4$sendByMetaMask;
    ...
    var _isApprovedForAll = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(_ref5) {
      ...
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              web3 = _ref5.web3, from = _ref5.from, exchangeAddress = _ref5.exchangeAddress, _ref5$nftType = _ref5.nftType, nftType = _ref5$nftType === void 0 ? NFTType.ERC1155 : _ref5$nftType, tokenAddress = _ref5.tokenAddress;
              _context7.prev = 1;
              _context7.next = 4;
              return this.callContractMethod(web3, NFTMethod.isApprovedForAll, [from, exchangeAddress], tokenAddress, nftType);
    ...
    var _depositNFT = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(_ref6) {
      ...
      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              web3 = _ref6.web3, from = _ref6.from, exchangeAddress = _ref6.exchangeAddress, _ref6$nftType = _ref6.nftType, nftType = _ref6$nftType === void 0 ? NFTType.ERC1155 : _ref6$nftType, tokenAddress = _ref6.tokenAddress, nftId = _ref6.nftId, amount = _ref6.amount, gasPrice = _ref6.gasPrice, gasLimit = _ref6.gasLimit, _ref6$chainId = _ref6.chainId, chainId = _ref6$chainId === void 0 ? ChainId.MAINNET : _ref6$chainId, nonce = _ref6.nonce, extraData = _ref6.extraData, _ref6$sendByMetaMask = _ref6.sendByMetaMask, sendByMetaMask = _ref6$sendByMetaMask === void 0 ? true : _ref6$sendByMetaMask;
              data = genExchangeData(NFTMethod.depositNFT, {
                from: from,
                to: from,
                nftType: nftType,
  ...
  _proto.computeNFTAddress = function computeNFTAddress(_ref7) {
    ...
    try {
      ...
      var codeHash = keccak(Buffer.from(CREATION_CODE[this.chainId], "hex"));
      var saltHash = keccak(saltBuf);
      var rawBuf = Buffer.concat([Buffer.from("ff", "hex"), Buffer.from(nftFactory.slice(2), "hex"), saltHash, codeHash]);
      var addr = keccak(rawBuf).slice(12).toString("hex");
      return {
        tokenAddress: toChecksumAddress("0x" + addr)
      };
    } catch (err) {
      return err;
    }
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              if (url === void 0) {
                url = LOOPRING_URLs.GET_DEFI_MARKETS;
              }
    ...
    var _getDualUserLocked = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee12(_ref, apiKey) {
      ...
      return runtime_1.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _ref$lockTag = _ref.lockTag, lockTag = _ref$lockTag === void 0 ? [DUAL_TYPE.DUAL_BASE, DUAL_TYPE.DUAL_CURRENCY] : _ref$lockTag, request = /*#__PURE__*/_objectWithoutPropertiesLoose(_ref, _excluded$2);
              reqParams = {
        ...
        while (1) {
          switch (_context17.prev = _context17.next) {
            ...
            case 66:
              ...
              ecdsaSignature = _result5.ecdsaSig + SigSuffix.Suffix02;
...
export { AMMtxTypes, AddressType, AmmPoolActivityStatus, AmmTxType, AmmpoolAPI, ApproveVal, AssetType, BaseAPI, BillType, BlindBoxStatus, ChainId, ClaimRecordStatus, ConnectorError, ConnectorNames, ContactAPI, Currency, DEPLOYMENT_STATUS, DUAL_TYPE, DefiAPI, DefiAction, DefiMarketStatus, DelegateAPI, ERC20Method, ExchangeAPI, FilledType, GetEcDSASigType, GlobalAPI, HEBAO_LOCK_STATUS, HEBAO_META_TYPE, IntervalType, IsMobile, KEY_MESSAGE, LABEL_INVESTMENT_STATUS, LOOPRING_URLs, LegacyNFT, LoopringErrorCode, LuckTokenAPI, LuckyTokenAmountType, LuckyTokenClaimType, LuckyTokenItemStatus, LuckyTokenItemStatusIndex, LuckyTokenViewType, LuckyTokenWithdrawStatus, MarketStatus, NFTAPI, NFTFactory, NFTFactory_Collection, NFTMethod, NFTType, NFT_IMAGE_SIZES, NFT_PREFERENCE_TYPE, NFT_TYPE_STRING, NetworkContextName, NetworkWallet, OffchainFeeReqType, OffchainNFTFeeReqType, OrderMakerType, OrderStatus, OrderType, OrderTypeResp, ReqMethod, RuleType, SEP, SETTLEMENT_STATUS, SIG_FLAG, Side, SigPatchField, SigSuffix, SortOrder, SoursURL, StakeStatus, StakeTransactionType, TradeChannel, TradesFillTypes, TradingInterval, TransferType, TxNFTType, TxStatus, TxType, UserAPI, UserBillTypes, UserNFTTxTypes, UserTxTypes, VipCatergory, WalletAPI, WhitelistedUserAPI, WithdrawalTypes, WsAPI, WsOps, WsTopicType, addHexPrefix, ammPoolCalc, approve, approveMax, approveZero, calcDefi, calcDex, calcDual, checkErrorInfo, clearHexPrefix, contractWalletValidate32, contractWallet as contractWallet_abi, convertPublicKey, convertPublicKey2, deposit, dumpError400, ecRecover, ecRecover2, eddsaSign, eddsaSignWithDomain, erc20 as erc20_abi, exchange_3_6 as exchange_abi, fcWalletValid, forceWithdrawal, formatAddress, formatEddsaKey, formatKey, formatSig, fromGWEI, fromWEI, genExchangeData, generateKeyPair, generatePrivateKey, getAccountArg, getAmmExitEcdsaTypedData, getAmmJoinEcdsaTypedData, getAmmpoolArg, getBaseQuote, getCandlestickArg, getCefiOrderBook, getCurPrice, getDisplaySymbol, getEcDSASig, getEdDSASig, getEdDSASigWithPoseidon, getExistedMarket, getMidPrice, getMinReceived, getMixOrderArg, getMixTradeArg, getNFTMintTypedData, getNFTTransferTypedData, getNFTWithdrawTypedData, getNftData, getNftTradeHash, getNonce, getOrderArg, getOrderBookArg, getOrderHash, getOutputAmount, getPair, getPriceImpact, getReserveInfo, getTickerArg, getToPrice, getToken, getTokenInfoById, getTokenInfoBySymbol, getTokenInfoByToken, getTradeArg, getTransferOldTypedData, getTransferTypedData, getUpdateAccountEcdsaTypedData, getWithdrawTypedData, get_EddsaSig_Dual_Order, get_EddsaSig_ExitAmmPool, get_EddsaSig_JoinAmmPool, get_EddsaSig_NFT_Mint, get_EddsaSig_NFT_Order, get_EddsaSig_NFT_Transfer, get_EddsaSig_NFT_Withdraw, get_EddsaSig_OffChainWithdraw, get_EddsaSig_Transfer, get_Is_Nft_Token, hasMarket, hebao as hebao_abi, isContract, isEmpty, makeAmmPool, makeExitAmmCoverFeeLP, makeExitAmmPoolMini, makeExitAmmPoolRequest2, makeJoinAmmPoolRequest, makeMarket, makeMarkets, mykeyWalletValid, numberWithCommas, padLeftEven, personalSign, recoverSignType, sendRawTx, sendTransaction, sign, signEip712, signEip712WalletConnect, signEthereumTx, signNFTMintWithDataStructure, signNFTMintWithDataStructureForContract, signNFTMintWithoutDataStructure, signNFTTransferWithDataStructureForContract, signNFTTransferWithoutDataStructure, signNFTWithdrawWithDataStructure, signNFTWithdrawWithDataStructureForContract, signNFTWithdrawWithoutDataStructure, signOffchainWithdrawWithDataStructure, signOffchainWithdrawWithDataStructureForContract, signOffchainWithdrawWithoutDataStructure, signTNFTransferWithDataStructure, signTransferWithDataStructure, signTransferWithDataStructureForContract, signTransferWithoutDataStructure, signUpdateAccountWithDataStructure, signUpdateAccountWithDataStructureForContract, signUpdateAccountWithoutDataStructure, sleep, sortObjDictionary, toBN, toBig, toBuffer, toFixed, toGWEI, toHex, toNumber, toWEI, updatePriceImpact_new, verifyEdDSASig, zeroPad };
//# sourceMappingURL=loopring-sdk.esm.js.map
